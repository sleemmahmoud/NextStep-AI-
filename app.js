...
function renderDashboard(){
  ...
  app.innerHTML = `
    ...
    <div class="tabs">
      <button class="tab ${tab==="overview"?"active":""}" data-action="tab" data-tab="overview">الرئيسية</button>
      <button class="tab ${tab==="recommended"?"active":""}" data-action="tab" data-tab="recommended">الفرص المقترحة</button>
      <button class="tab ${tab==="tracking"?"active":""}" data-action="tab" data-tab="tracking">متابعتي</button>
      <button class="tab ${tab==="guides"?"active":""}" data-action="tab" data-tab="guides">أدلة ومصادر</button>
      <button class="tab ${tab==="resources"?"active":""}" data-action="tab" data-tab="resources">مركز التعلم</button>
      <button class="tab ${tab==="assessments"?"active":""}" data-action="tab" data-tab="assessments">الاختبارات</button>
      <button class="tab ${tab==="stories"?"active":""}" data-action="tab" data-tab="stories">قصص النجاح</button>
