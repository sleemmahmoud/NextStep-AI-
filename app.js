...
لو مش متأكد إن الفرصة حقيقية، متضيفهاش. لو مفيش فرص كفاية رجّع [].`;
  try{
    // مهلة 80 ثانية (بدل 55) + إعادة محاولة تلقائية مرة — الطلب ده بيولّد لحد 5
    // فرص بتفاصيلها كـJSON منظّم، وده بياخد وقت أطول من رد شات عادي وممكن
    // يعدي 55 ثانية بسهولة في أوقات الضغط على الموديل.
