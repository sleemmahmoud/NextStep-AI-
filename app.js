...
let state = {
  ...
  aggregatorTriggering:false, aggregatorLastRun:null, aggregatorMsg:"",
...
function renderAggregatorLastRun(){
  ...
  return `<div style="margin-top:8px;font-size:12.5px;color:#5C7278;">
    آخر تشغيلة (${when}) — مصادر: ${r.sourcesChecked||0}، جديدة: ${r.totalNew||0}، محدَّثة: ${r.totalUpdated||0}، مرفوضة: ${r.totalRejected||0}، أخطاء مصادر: ${r.totalErrors||0}
  </div>`;
}
