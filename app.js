...
// نسخة مخصصة لأنظمة ATS: بدون صورة، وبدون badges/pills ملونة (بعض أنظمة الفرز
// بتفشل تقرأ نصوص جوه عناصر معقدة)، بس عناوين وفقرات ونقط نص عادي بسيط.
...
function printCV(){
  ...
  <style>body{margin:0;font-family:'Cairo',Tahoma,Arial,sans-serif;}</style></head><body>${buildAtsCvHtml(p)}</body></html>`);
  win.document.close();
