...
const HELP_TEXT = {
  ...
  profile:{title:"ملفي", body:"بياناتك الشخصية، اهتماماتك ومهاراتك، وزرار تحميل CV احترافي بضغطة واحدة. وتحت في \"خطة التطوير\" هتلاقي الجديد من آخر زيارة، متابعة الفرص اللي قدّمت عليها، وروودماب خطوة بخطوة لكل مهارة عايز تتعلمها."},
...
function renderDevelopmentPlanSection(){
  const p = state.profile;
  ...
  return `
  <div class="section-label" style="margin-top:20px;">خطة التطوير</div>
  ...
  <div class="section-label" style="margin-top:20px;">روودماب المهارات</div>
  ${renderRoadmapBlock()}
  `;
}
