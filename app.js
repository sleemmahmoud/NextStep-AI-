...
// قللنا حد المستخدم العادي (الحصة المجانية لـGemini مش هتستحمل كتير)، والأدمن
// ليه حد أعلى شوية بس برضه محدود مش لا نهائي — لازم الرقمين يفضلوا مطابقين
// لـDAILY_LIMIT وADMIN_DAILY_LIMIT في worker.ts.
const AI_DAILY_LIMIT = 3;
const ADMIN_AI_DAILY_LIMIT = 8;
