...
const firebaseConfig = {
  apiKey: "AIzaSyBuaRV445ZcVWZTe5sGA5Hi6Kx_YYrwLFU",
  authDomain: "nextstep-ai-bf090.firebaseapp.com",
  projectId: "nextstep-ai-bf090",
  storageBucket: "nextstep-ai-bf090.firebasestorage.app",
  messagingSenderId: "160220062606",
  appId: "1:160220062606:web:c752b069695bad9a94badf",
  measurementId: "G-K4T4D9HEWX"
};
...
const ADMIN_EMAILS = ["sleemkahraba123@gmail.com"];
function isAdmin(){
...
// بروكسي OpenRouter — Cloudflare Worker بيخبي مفتاح الـAPI عن العميل تمامًا.
// غيّر الرابط ده لرابط الـWorker بتاعك بعد النشر (شكله https://<اسم>.<حسابك>.workers.dev)
const AI_PROXY_URL = "https://nextstep-ai.mhmwdshhath468.workers.dev";
...
استخدم البيانات دي عشان تدّي نصايح مخصصة قدر الإمكان، ومتقولش إنك موديل لغوي أو تتكلم عن نفسك كـAI إلا لو اتسأل مباشرة.`;
  ...
  try{
    ...
    if(!res.ok){
      ...
      return `⚠️ حصل خطأ: "${errMsg}"\n\nتأكد إن الـWorker شغّال وإن مفتاح OpenRouter مظبوط في إعداداته.`;
    }
    return (data && data.response) || "معرفتش أرد على السؤال ده، جرب تصيغه بطريقة تانية.";
  }catch(err){
