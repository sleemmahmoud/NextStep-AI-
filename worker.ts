...
// حد يومي واحد بسيط لكل مستخدم (وواحد تاني أعلى شوية للأدمن) — بيتحسب على كل
// استخدامات الـAI مع بعض (شات + بحث + CV) من غير أي تقسيم بميزات، عشان النظام
// يفضل أبسط وأسهل في المتابعة.
const DAILY_LIMIT = 3;
const ADMIN_DAILY_LIMIT = 4;
